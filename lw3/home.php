...
<body>
        ...
        <nav class="navigation container">
            ...
            <ul class="navigation__list">
                <li class="navigation__item">
                    <a href="#" class="navigation__link" style="color: #FFFFFF">Home</a>
                </li>
                <li class="navigation__item">
                    <a href="#" class="navigation__link" style="color: #FFFFFF">Categories</a>
                </li>
                <li class="navigation__item">
                    <a href="#" class="navigation__link" style="color: #FFFFFF">About</a>
                </li>
                <li class="navigation__item">
                    <a href="#" class="navigation__link" style="color: #FFFFFF">Contact</a>
                </li>
            </ul>
        </nav>
        <div class="banner">
            <div class="banner__content">
                <h1 class="banner__content__title">Let's do it together.</h1>
                <p class="banner__content__subtitle">We travel the world in search of stories. Come along for the ride.
                </p>
                <a href="#" class="banner__content__button">View Latest Posts</a>
            </div>
        </div>
    </header>
    <main>
    ...
    <footer class="footer">
        <nav class="navigation container">
            ...
            <ul class="navigation__list">
                <li class="navigation__item">
                    <a href="#" class="navigation__link" style="color: #FFFFFF99">Home</a>
                </li>
                <li class="navigation__item">
                    <a href="#" class="navigation__link" style="color: #FFFFFF99">Categories</a>
                </li>
                <li class="navigation__item">
                    <a href="#" class="navigation__link" style="color: #FFFFFF99">About</a>
                </li>
                <li class="navigation__item">
                    <a href="#" class="navigation__link" style="color: #FFFFFF99">Contact</a>
                </li>
            </ul>
        </nav>
    </footer>
